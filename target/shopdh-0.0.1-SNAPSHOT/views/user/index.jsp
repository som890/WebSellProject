...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img style="height: 700px;" src="template/user/image/banner.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img style="height: 700px;" src="template/user/image/banner1.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img style="height: 700px;" src="template/user/image/banner2.webp" class="d-block w-100" alt="...">
        </div>
    </div>
        ...
        <div class="container">
            <ul id="myTab" role="tablist">
                <li class="nav-item tab-li" role="presentation">
                  <button class="active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Sản phẩm mới</button>
                </li>
                <li class="nav-item tab-li" role="presentation">
                            ...
                            <div class="paginationss">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination" id="listpage">
                                      ...
                                      <li class="page-item"><a class="page-link" href="home?page=${pages}">${pages}</a></li>
                                      </c:forEach>
