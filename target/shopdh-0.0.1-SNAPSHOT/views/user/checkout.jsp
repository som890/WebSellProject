    ...
    <div class="container">
       <div class="row table-cart">
            ...
            <div class="col-md-4 chitietcheckout">
                ...
                <form action="paymentmomo" method="post">
                	<input id="ghichumomo" name="ghichumomo" style="display: none;">
                	<button class="btn-momo"><img src="template/user/image/momo.png" class="pay-momo"> Thanh toán bằng momo</button>
                </form>
            </div>
       </div>
    </div>
