    ...
    <div class="container">
       <div class="row table-cart">
            <div class="col-md-8">
                ...
                <button class="btn-tieptucmuahang" onclick="location.href=indexUser" type="button">Tiếp tục mua hàng</button>
            </div>
            <div class="col-md-4 chitietdathang">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td onclick="location.href='checkout'" colspan="2"><button onclick="location.href=''" type="button" class="btn-thanhtoandonhang">Thanh toán đơn hàng</button></td>
                    </tr>
                </table>
            </div>
       </div>
